<form method="post" action="<?php echo base_url(); ?>Car/insert_extra_carone">
...
<div class="form-horizontal">
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input class="xcrud-input form-control" data-required="1" type="text" data-type="text" value="<?php echo $post->name;?>" name="name" maxlength="250">
            <input type="hidden" name="extra_car_id" value="<?php echo $post->id;?>" />  
        </div>
    </div>
    <div class="form-group">
