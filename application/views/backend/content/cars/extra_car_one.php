<form method="post" action="<?php echo base_url(); ?>Car/insert_carone" enctype="multipart/form-data">
        ...
        <div class="col-sm-9">
            <div class="xcrud-upload-container">
                <div class="btn-group"><span class="xcrud-noimage btn btn-default disabled">no image</span>
                    <input name="cHRfZXh0cmFzLmV4dHJhc19pbWFnZQ--" value="" type="hidden" class="xcrud-input"><span class="xcrud-add-file btn btn-success"><i class="glyphicon glyphicon-upload"></i> Add image<input id="xfupl1693618204" type="file" data-type="image" data-field="pt_extras.extras_image" class="xcrud-upload" name="thumb"></span><?php if (isset($error_file)) {
                                        echo "$error_file";
                                    } ?></div>
            </div>
        </div>
