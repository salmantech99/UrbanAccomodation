                    ...
                    <div class="box effect1">
                        ...
                        <div class="table-responsive" id="printableArea">
                            <form action="" name="delete-form" method="post">
                                <a href="<?php echo site_url('Car/extra_car_one/'); ?>"><button type="button" class="btn btn-success btn-md btn-margin">
                                <i class="fas fa-plus-circle"></i>&nbsp; ADD</button></a>
                                <div class="btn-hotel">
                                    <button type="button" class="btn btn-danger btn-sm delete_all" data-url="/itemDelete" id="del_all">
                                ...
                                <table class="table table-hover table-earning">
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="text-align: center;">
                                            ...
                                            <td><a href="<?php echo site_url('Car/car_show/'); ?>"><?php echo anchor('Car/update_extra_car?id='.$post->id, '<i class="fas fa-edit "></i>', 'id="$post->id"'); ?></a></td>
                                            <td class="hotel-add-alignment delete"><?php echo anchor('Car/delete10?id='.$post->id, '<i class="fas fa-times"></i>', 'id="$post->id"'); ?></td>
                                        </tr>
                                         <?php } ?>
                                    </tbody>
                                </table>
...
<script type="text/javascript">
    ...
    $('.delete_all').on('click', function(e) {
        var id = $(this).data('Car/delete_extra_cars');
        var allVals = [];
       ...
       var matches = document.getElementsByClassName('id_check');
        ...
        {  
            ...
            {  
                ...
                {
                    $.ajax({
                        url: '<?php echo base_url() ?>Car/delete_extra_cars',
                        type: 'POST',
                        data: 'ids='+allVals[i],
