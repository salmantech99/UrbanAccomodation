                    ...
                    <div class="box effect1">
                        ...
                        <div class="table-responsive" id="printableArea">
                            <form action="" name="delete-form" method="post">
                                <a href="<?php echo site_url('Hotels/extras_one/'); ?>"><button type="button" class="btn btn-success btn-md btn-margin">
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="text-align: center;">
                                          ...
                                          <td class="hotel-add-alignment"><i class="fas fa-check tick"></i></td>
                                            ...
                                            <td class="hotel-add-alignment"><a href="<?php echo site_url('Hotels/update_hotel_extras/'); ?>"><?php echo anchor('Hotels/update_hotel_extras?id='.$post->id, '<i class="fas fa-edit "></i>', 'id="$post->id"'); ?></a></td>
                                            <td class="hotel-add-alignment delete"><?php echo anchor('Hotels/delete2?id='.$post->id, '<i class="fas fa-times"></i>', 'id="$post->id"'); ?></td>
                                        </tr>
                                        <?php } ?>
...
<script type="text/javascript">
    ...
    $('.delete_all').on('click', function(e) {
        var id = $(this).data('Hotels/delete_extra_hotel');
        var allVals = [];
       ...
       var matches = document.getElementsByClassName('id_check');
        ...
        {  
            ...
            {  
                ...
                {
                    $.ajax({
                        url: '<?php echo base_url() ?>Hotels/delete_extra_hotel',
                        type: 'POST',
                        data: 'ids='+allVals[i],
