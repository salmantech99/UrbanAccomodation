    ...
    <div class="row">
        <div class="col-md-8">
            <div class="xcrud-top-actions btn-group">
                <a href="#" data-task="save" data-after="list" class="btn btn-primary xcrud-action">Save &amp; Return</a>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input class="xcrud-input form-control" data-required="1" type="text" data-type="text" value="" name="cHRfZXh0cmFzLmV4dHJhc190aXRsZQ--" maxlength="250"></div>
    </div>
    <div class="form-group">
        <label class="control-label col-sm-3">Status*</label>
        <div class="col-sm-9">
            <select class="xcrud-input form-control" data-required="1" data-type="select" name="cHRfZXh0cmFzLmV4dHJhc19zdGF0dXM-" maxlength="0">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input class="xcrud-input form-control" data-required="1" type="text" data-type="float" value="" name="cHRfZXh0cmFzLmV4dHJhc19iYXNpY19wcmljZQ--" data-pattern="numeric">
        </div>
    </div>
    </div>
</div>
