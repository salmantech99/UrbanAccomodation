                    ...
                    <div class="box effect1">
                        ...
                        <div class="table-responsive" id="printableArea">             
                            <form action="" name="delete-form" method="post">
                                <a href="<?php echo site_url('Hotels/room_one/'); ?>"><button type="button" class="btn btn-success btn-md btn-margin">
                                ...
                                <table class="table table-hover table-earning">
                                    ...
                                    <tbody> 
                                        ...
                                        <tr>
                                            ...
                                            <td class="hotel-add-alignment"><?php echo $post->room_type;?></td>
                                            <td class="hotel-add-alignment"><?php echo $post->quantity;?></td>
                                            <td class="hotel-add-alignment"><?php echo $post->price;?></td>
                                            <td class="hotel-add-alignment"><i class="fas fa-check tick"></i></td>
                                            <td class="hotel-add-alignment"><a href="<?php echo site_url('Hotels/update_room_one/'); ?>"><?php echo anchor('Hotels/update_room_one?id='.$post->id, '<i class="fas fa-edit "></i>', 'id="$post->id"'); ?></a></td>
                                            <td class="hotel-add-alignment delete"><?php echo anchor('Hotels/delete1?id='.$post->id, '<i class="fas fa-times"></i>', 'id="$post->id"'); ?></td>
                                        </tr>
                                        <?php } ?>
                                        </tr>
                                    </tbody>
...
<script type="text/javascript">
    ...
    $('.delete_all').on('click', function(e) {
        var id = $(this).data('Hotels/delete_rooms');
        var allVals = [];
       ...
       var matches = document.getElementsByClassName('id_check');
        ...
        {  
            ...
            {  
                ...
                {
                    $.ajax({
                        url: '<?php echo base_url() ?>Hotels/delete_rooms',
                        type: 'POST',
                        data: 'ids='+allVals[i],
