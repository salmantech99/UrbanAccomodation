<form method="post" action="<?php echo base_url(); ?>Flights/insert_slider" enctype="multipart/form-data">
...
<div class="form-horizontal">
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input class="xcrud-input form-control" data-required="1" type="text" data-type="text" value="" name="title" maxlength="250"></div>
    </div>
    <div class="form-group">
