<form method="post" action="<?php echo base_url(); ?>Flights/insert_country">
...
<div class="form-horizontal">
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input class="xcrud-input form-control" data-required="1" type="text" data-type="text" value="" name="iso" maxlength="250"></div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input class="xcrud-input form-control" data-required="1" type="text" data-type="text" value="" name="nicename" maxlength="250"></div>
    </div>
    <div class="form-group">
        <label class="control-label col-sm-3">Iso3*</label>
        <div class="col-sm-9">
            <input class="xcrud-input form-control" data-required="1" type="text" data-type="float" value="" name="iso3" data-pattern="numeric">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-sm-3">Numcode*</label>
        <div class="col-sm-9">
            <input class="xcrud-input form-control" data-required="1" type="text" data-type="text" value="" name="numcode" maxlength="250"></div>
    </div>
    <div class="form-group">
        <label class="control-label col-sm-3">Phonecode*</label>
        <div class="col-sm-9">
            <input class="xcrud-input form-control" data-required="1" type="text" data-type="text" value="" name="phonecode" maxlength="250"></div>
    </div>
