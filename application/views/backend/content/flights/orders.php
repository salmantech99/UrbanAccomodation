                                ...
                                <table class="table table-hover table-earning">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Airline Id</th>
                                            <th>Order By</th>
                                            <th>Customer Passport Number</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="hotel-add-alignment"><?php echo $post->title;?> <?php echo $post->customer_name;?></td>
                                            <td class="hotel-add-alignment"><?php echo $post->passport_number;?></td>
                                            <td class="hotel-add-alignment"><?php echo $post->mobile_code;?><?php echo $post->mobile_number;?></td>
