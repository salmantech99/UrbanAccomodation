            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="box effect1">
                        <h4 class="hotel-table">FLIGHT MANAGEMENT</h4>
                        <hr>
                        <div class="table-responsive" id="printableArea">
                            <form action="" name="delete-form" method="post">
                                <a href="<?php echo site_url('Flights/routes_add/'); ?>"><button type="button" class="btn btn-success btn-md btn-margin">
                                ...
                                <table class="table table-hover table-earning">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="hotel-add-alignment"><?php echo $post->departure_city;?></td>
                                            <td class="hotel-add-alignment"><?php echo $post->arrival_city;?></td>
                                            <td class="hotel-add-alignment"><?php echo $post->status;?></td>
                                            <td class="hotel-add-alignment"><?php echo $post->total_hours;?></td>
                                            <td class="hotel-add-alignment"><?php echo $post->departure_date;?></td>
                                            <td class="hotel-add-alignment"><?php echo $post->arrival_date;?></td>
                                            <td class="hotel-add-alignment"><?php echo $post->departure_time;?></td>
                                            <td class="hotel-add-alignment"><?php echo $post->arrival_time;?></td>
                                            <td class="hotel-add-alignment"><a href="<?php echo site_url('Flights/update_flight/'); ?>"><?php echo anchor('Flights/update_flight?id='.$post->id, '<i class="fas fa-edit "></i>', 'id="$post->id"'); ?></a></td>
                                            <td class="hotel-add-alignment delete"><?php echo anchor('Flights/delete4?id='.$post->id, '<i class="fas fa-times"></i>', 'id="$post->id"'); ?></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
...
<script type="text/javascript">
    ...
    $('.delete_all').on('click', function(e) {
        var id = $(this).data('Flights/delete_flights');
        var allVals = [];
       ...
       var matches = document.getElementsByClassName('id_check');
        ...
        {  
            ...
            {  
                ...
                {
                    $.ajax({
                        url: '<?php echo base_url() ?>Flights/delete_flights',
                        type: 'POST',
                        data: 'ids='+allVals[i],
