            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="box effect1">
                        <h4 class="hotel-table">COUNTRIES MANAGEMENT</h4>
                        <hr>
                        <div class="table-responsive" id="printableArea">
                            <form action="" name="delete-form" method="post">
                                <a href="<?php echo site_url('Flights/country_extras/'); ?>"><button type="button" class="btn btn-success btn-md btn-margin">
                                <i class="fas fa-plus-circle"></i>&nbsp; ADD</button></a>
                                <div class="btn-hotel">
                                    <button type="button" class="btn btn-danger btn-md delete_all">
                                ...
                                <table class="table table-hover table-earning">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="hotel-add-alignment"><?php echo $post->iso;?></td>
                                            <td class="hotel-add-alignment"><?php echo $post->name;?></td>
                                            <td class="hotel-add-alignment"><?php echo $post->nicename;?></td>
                                            <td class="hotel-add-alignment"><?php echo $post->iso3;?></td>
                                            <td class="hotel-add-alignment"><?php echo $post->numcode;?></td>
                                            <td class="hotel-add-alignment"><?php echo $post->phonecode;?></td>
                                            <td class="hotel-add-alignment"><i class="fas fa-search search"></i></td>
                                            <td class="hotel-add-alignment"><a href="<?php echo site_url('Flights/update_countries/'); ?>"><?php echo anchor('Flights/update_countries?id='.$post->id, '<i class="fas fa-edit "></i>', 'id="$post->id"'); ?></a></td>
                                            <td class="hotel-add-alignment delete"><?php echo anchor('Flights/delete7?id='.$post->id, '<i class="fas fa-times"></i>', 'id="$post->id"'); ?></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
...
<script type="text/javascript">
    ...
    $('.delete_all').on('click', function(e) {
        var id = $(this).data('Flights/delete_countries');
        var allVals = [];
       ...
       var matches = document.getElementsByClassName('id_check');
        ...
        {  
            ...
            {  
                ...
                {
                    $.ajax({
                        url: '<?php echo base_url() ?>Flights/delete_countries',
                        type: 'POST',
                        data: 'ids='+allVals[i],
