            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="box effect1">
                        <h4 class="hotel-table">AIRLINES MANAGEMENT</h4>
                        <hr>
                        <div class="table-responsive" id="printableArea">
                            <form action="" name="delete-form" method="post">
                                <a href="<?php echo site_url('Flights/airline_extras/'); ?>"><button type="button" class="btn btn-success btn-md btn-margin">
                                ...
                                <table class="table table-hover table-earning">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="hotel-add-alignment"><?php echo $post->latadesi;?></td>
                                            <td class="hotel-add-alignment"><?php echo $post->digit;?></td>
                                            <td class="hotel-add-alignment"><?php echo $post->country;?></td>
                                            <td class="hotel-add-alignment"><i class="fas fa-search search"></i></td>
                                            <td class="hotel-add-alignment"><a href="<?php echo site_url('Flights/update_airline/'); ?>"><?php echo anchor('Flights/update_airline?id='.$post->id, '<i class="fas fa-edit "></i>', 'id="$post->id"'); ?></a></td>
                                            <td class="hotel-add-alignment delete"><?php echo anchor('Flights/delete6?id='.$post->id, '<i class="fas fa-times"></i>', 'id="$post->id"'); ?></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
...
<script type="text/javascript">
    ...
    $('.delete_all').on('click', function(e) {
        var id = $(this).data('Flights/delete_airlines');
        var allVals = [];
       ...
       var matches = document.getElementsByClassName('id_check');
        ...
        {  
            ...
            {  
                ...
                {
                    $.ajax({
                        url: '<?php echo base_url() ?>Flights/delete_airlines',
                        type: 'POST',
                        data: 'ids='+allVals[i],
