            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="box effect1">
                        <h4 class="hotel-table">Vacation MANAGEMENT</h4>
                        <hr>
                        <div class="table-responsive" id="printableArea">
                            <form action="" name="delete-form" method="post">   
                                <a href="<?php echo site_url('Vacation/vacations_add/'); ?>"><button type="button" class="btn btn-success btn-md btn-margin">
                                ...
                                <table class="table table-hover table-earning">
                                    ...
                                    <tbody>
                                        ...
                                        <tr> 
                                            ...
                                            <td class="hotel-add-alignment"><img style="width: 55px;" src="<?php echo base_url('uploads/'.$post->vacational_place_image); ?>" /> </td>
                                            <td class="hotel-add-alignment"><?php echo $post->vacation_name;?></td>
                                            <td class="hotel-add-alignment"><?php echo $post->stars;?></td>
                                            <td class="hotel-add-alignment"><?php echo $post->location1;?></td>
                                            <td class="hotel-add-alignment"><i class="fas fa-check tick"></i></td>
                                            <td class="hotel-add-alignment edit"><a href="<?php echo site_url('Hotels/update_hotel_one/'); ?>"><?php echo anchor('Vacation/update_vacation?id='.$post->id, '<i class="fas fa-edit "></i>', 'id="$post->id"'); ?></a></td>
                                             <td class="hotel-add-alignment delete"><?php echo anchor('Vacation/delete?id='.$post->id, '<i class="fas fa-times"></i>', 'id="$post->id"'); ?></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
...
<script type="text/javascript">
    ...
    $('.delete_all').on('click', function(e) {
        var id = $(this).data('Vacation/delete_selected_vacation');
        var allVals = [];
       ...
       var matches = document.getElementsByClassName('id_check');
        ...
        {  
            ...
            {  
                ...
                {
                    $.ajax({
                        url: '<?php echo base_url() ?>Vacation/delete_selected_vacation',
                        type: 'POST',
                        data: 'ids='+allVals[i],
