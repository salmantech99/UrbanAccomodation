                    ...
                    <div class="box effect1">
                        ...
                        <div class="table-responsive" id="printableArea">
                            <form action="" name="delete-form" method="post">
                                <a href="<?php echo site_url('Vacation/vacations_extra_add/'); ?>"><button type="button" class="btn btn-success btn-md btn-margin">
                                ...
                                <table class="table table-hover table-earning">
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="text-align: center;">
                                            ...
                                            <td class="hotel-add-alignment"><a href="<?php echo site_url('Hotels/update_hotel_extras/'); ?>"><?php echo anchor('Vacation/update_vacation_extras?id='.$post->id, '<i class="fas fa-edit "></i>', 'id="$post->id"'); ?></a></td>
                                            <td class="hotel-add-alignment delete"><?php echo anchor('Vacation/delete_extra?id='.$post->id, '<i class="fas fa-times"></i>', 'id="$post->id"'); ?></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
...
<script type="text/javascript">
    ...
    $('.delete_all').on('click', function(e) {
        var id = $(this).data('Vacation/delete_extra_vacation');
        var allVals = [];
       ...
       var matches = document.getElementsByClassName('id_check');
        ...
        {  
            ...
            {  
                ...
                {
                    $.ajax({
                        url: '<?php echo base_url() ?>Vacation/delete_extra_vacation',
                        type: 'POST',
                        data: 'ids='+allVals[i],
