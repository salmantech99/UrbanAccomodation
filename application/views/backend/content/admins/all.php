            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="box effect1">
                        <h4 class="hotel-table">Manage Admins</h4>
                        <hr>
                        <div class="table-responsive" id="printableArea">
                            <form action="" name="delete-form" method="post">
                                <a href="<?php echo site_url('Admin/add_admin/'); ?>"><button type="button" class="btn btn-success btn-md btn-margin">
                                        ...
                                        <?php foreach($admins as $admin){?>
											<tr>
												<td><label class="control control--checkbox">
													<input type="checkbox" data-id="<?php echo $admin->id;?>" value="<?php echo $admin->id;?>" class="checkbox id_check"/>
													<div class="control__indicator"></div>
												</label></td>
												<td class="hotel-add-alignment"><?php echo $admin->id;?></td>
												<td class="hotel-add-alignment"><?php echo $admin->username;?></td>
												<td class="hotel-add-alignment"><?php echo $admin->email_address;?></td>
												<td class="hotel-add-alignment"><?php echo $admin->dob;?></td>
												<td class="hotel-add-alignment"><?php echo $admin->mobile_number;?></td>
												<td class="hotel-add-alignment"><?php echo $admin->country;?></td>
												<td class="hotel-add-alignment"><i class="fas fa-check tick hotel-add-alignment"></i></td>
												<td class="hotel-add-alignment"><a href="<?php echo site_url('Admin/update_admin'); ?>"><?php echo anchor('Admin/update_admin?id='.$admin->id, '<i class="fas fa-edit "></i>', 'id="$admin->id"'); ?></a></td>
												<td class="hotel-add-alignment delete"><?php echo anchor('Admin/delete?id='.$admin->id, '<i class="fas fa-times"></i>', 'id="$admin->id"'); ?></td>
											</tr>
                                         <?php } ?>
                                    </tbody>
                                </table>
...
<script type="text/javascript">
    ...
    $('.delete_all').on('click', function(e) {
        var id = $(this).data('Admin/delete_selected_admins');
        var allVals = [];
       ...
       var matches = document.getElementsByClassName('id_check');
        ...
        {  
            ...
            {  
                ...
                {
                    $.ajax({
                        url: '<?php echo base_url() ?>Admin/delete_selected_admins',
                        type: 'POST',
                        data: 'ids='+allVals[i],
