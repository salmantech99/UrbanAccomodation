          ...
          <div class="row" data-aos="fade-left">
            <div class="col-md-5 col-sm-12 col-xs-12 ">
              <ul class="nav top-nav top-nav-option1">
                  <li class="nav-item">
                    <a href="<?php echo site_url('Login/user_profile/'); ?>" class="nav-link d-md-block d-none"><i class="fas fa-user"></i> <?php echo $posts->register_name;?></a>
                  </li>
                  <div class="nav top-nav">
                    <li class="nav-item">
                    <a href="<?php echo site_url('Login/user_profile/'); ?>" class="nav-link d-sm-block  d-md-none"><i class="fas fa-user"></i> <?php echo $posts->register_name;?></a>
                    </li>
                    <li class="nav-item top-nav-opt">
                    <a href="<?php echo site_url('Login/user_profile/'); ?>" class="nav-link d-sm-block  d-md-none"><i class="fas fa-cog"></i></a>
                    </li>
                    <li class="nav-item">
                    <a href="<?php echo site_url('Login/logout/'); ?>" class="nav-link d-sm-block  d-md-none"><i class="fas fa-power-off"></i></a>
                    </li>
                  </div>
                </ul>
              </div>
              <div class="col-md-7 col-xs-12 col-sm-12" >
                <ul class="nav top-nav top-option-right">
                    <li class="nav-item">
                    <a href="<?php echo site_url('Login/user_profile/'); ?>" class="nav-link d-md-block d-none"><i class="fas fa-cog"></i> Account Settings</a>
                    </li>
                     <li class="nav-item">
                    <a href="<?php echo site_url('Login/logout1/'); ?>" class="nav-link d-md-block d-none"><i class="fas fa-power-off"></i> Logout</a>
                    </li>
                </ul>
              </div>     
          </div> 
