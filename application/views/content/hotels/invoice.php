              ...
              <div class="col-md-11 col-md-11 invoice-res-work">
                <div class="customer-order-car">
                  <div class="row">
                    <div class="col-md-6 col-sm-6">
                        <h4 class="car-order-invoice-heading"><span class="heading-invoice-car"><?php echo $post->hotel_name;?></span></h4>
                    </div>
                    <div class="col-md-6 col-sm-6">
                        <h4 class="car-order-invoice-heading1"><span class="heading-invoice-car"><?php echo $post->location;?></span></h4>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6 col-sm-6">
                    <img src="<?php echo base_url('uploads/'.$post->hotel_image); ?>" class="invoice-img-car">
                    <p class="customer-order-car-detail">Featured From</p>
                    <p class="customer-order-car-detail">Featured To</p>
                    <p class="customer-order-car-detail">Hotel Type</p>
                    <p class="customer-order-car-detail">Total Days</p>
                    <p class="customer-order-car-detail">Maximum Adult</p>
                    <p class="customer-order-car-detail">Maximum Child</p>
                  </div>
                  <div class="col-md-6 col-sm-6" style="margin-top: 78px;">
                    <p class="customer-order-car-detail1"><?php echo $post->featured_from;?></p>
                    <p class="customer-order-car-detail1"><?php echo $post->featured_to;?></p>
                    <p class="customer-order-car-detail1"><?php echo $post->hotel_type;?></p>
                    <p class="customer-order-car-detail1"><?php
                      ...
                      ?></p>
                    <p class="customer-order-car-detail1"><?php echo $post->max_adults;?></p>
                    <p class="customer-order-car-detail1"><?php echo $post->max_children;?></p>
                  </div>
                </div>
                <div class="invoice-table-work">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <tr>
                        <td class="invoice-table-first-heading">$ <?php echo $deposit_now; ?></td>
                        <td class="invoice-table-second-heading">$ <?php echo $tax; ?></td>
