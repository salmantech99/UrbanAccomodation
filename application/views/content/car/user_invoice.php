                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>$ <?php echo $car_booking_deposit; ?></td>
                                    </tr>
                                    <tr>
                                        <td class="pe-1">Tax & Vat:</td>
                                        <td>$ <?php echo $car_booking_tax; ?></td>
                                    </tr>
                                    <tr>
                    ...
                    <div class="table-responsive mt-2">
                      <table class="table m-0 table_custom">
                            <thead>
                              <tr>
                                ...
                                <tr>
                                    <th class="py-1 ps-4">Car</th>
                                    <th class="py-1 ps-4">Area</th>
                         ...
                         <tbody>
                           <tr style="height:25px;">
                            <td class="py-1 ps-4">
                              <p class="fw-semibold mb-25"><?php echo $car_name;?></p>
                            </td>
                             <td class="py-1 ps-4">
                              <p class="fw-semibold mb-25"><?php echo $car_booking_pickup;?></p>
                             </td>
                            <td class="py-1 ps-4">
                              <p class="fw-semibold mb-25"><?php echo $car_book_pickupdate;?></p>
                             </td>
                             <td class="py-1 ps-4">
                              <p class="fw-semibold mb-25"><?php
                      ...
                      <br>
                        <table class="table m-0 table_custom">
                            <thead>
                                <tr>
                                  <th colspan="7"><strong>Pickup Information</strong></th>
                                </tr>
                                <tr>
                                    <th class="py-1 ps-4">Pick Up</th>
                                    <th class="py-1">Drop Off</th>
                                    <th class="py-1">Pick Up Date</th>
                                    <th class="py-1">Pick Up Time</th>
                                    <th class="py-1">Drop Off Date</th>
                                    <th class="py-1">Drop Off Time</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    ...
                                    <td class="py-1 ps-4">
                                        <p class="fw-semibold mb-25"><?php echo $car_booking_dropoff;?></p>
                                    </td>
                                    <td class="py-1 ps-4">
                                        <p class="fw-semibold mb-25"><?php echo $car_book_pickupdate;?></p>
                                    </td>
                                    <td class="py-1 ps-4">
                                        <p class="fw-semibold mb-25"><?php echo $car_book_pickuptime;?></p>
                                    </td>
                                    <td class="py-1 ps-4">
                                        <p class="fw-semibold mb-25"><?php echo $car_book_dropoffdate;?></p>
                                    </td>
                                    <td class="py-1 ps-4">
                                        <p class="fw-semibold mb-25"><?php echo $car_book_dropofftime;?></p>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="d-flex justify-content-between flex-md-row flex-column pb-2">
                        ...
                        <div class="mt-md-0 mt-2">
                            <div class="invoice-date-wrapper mb-50">
                                ...
                                <strong><span>$ <?php echo $car_booking_deposit; ?></span></strong>
                            </div>
                            <div class="invoice-date-wrapper">
                                <span class="invoice-date-title">TAX & VAT:</span>
                                <strong><span>$ <?php echo $car_booking_tax; ?></span></strong>
                            </div>
                            <div class="invoice-date-wrapper">
