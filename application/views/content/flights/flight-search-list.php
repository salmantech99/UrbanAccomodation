...
<div class="container one-way-margin">
  <div class="row">
    ...
    <div class="col-md-8">
      <ul class="jul bbb-july-b-b d-md-block d-none">
        <div class="row">
          <div class="col-md-2 d-md-block d-none">
            <button type="button" class="btn butn-deal1-btn july-left" style="margin-left: 10px;"><img src="<?php echo base_url(); ?>assets/image/travo/larrow.png"></button>
          </div>
          <div class="col-md-8 center slider-slider">
            <?php foreach($posts as $post){?>
            <div>
              <li class="jul-lili list-slide"><a href="#home" class="july b-july-list"><?php echo $post->departure_date;?><br><span class="july-red">$<?php echo $uni = $post->price_adults + $post->price_infant + $post->price_child;?></span></a></li>
            </div>
            <?php } ?>      
          </div>
          <div class="col-md-2 d-md-block d-none">
            <button type="button" class="btn butn-deal1-btn july-right"><img src="<?php echo base_url(); ?>assets/image/travo/rarrow.png"></button>
          </div>
        </div>  
      </ul>
      <ul class="jul d-md-block d-none">
        <li class="jul-li"><a href="#home">AIRLINE</a></li>
        <li class="jul-li"><a href="#news">DEPART</a></li>
        <li class="jul-li"><a href="#contact">ARRIVE</a></li>
        <li class="jul-li"><a href="#about">DURATION</a></li>
        <li class="jul-li"><a href="#about">ADULT PRICE</a></li>
      </ul>
      <?php foreach($posts as $post){?>
      <div id="fromList">
        <div id="computers">
          <div class="system bbb-july-b" data-price="<?php echo $uni = $post->price_adults + $post->price_infant + $post->price_child;?>">
            <input type="hidden" name="" value="<?php echo $post->departure_airline;?>" />
            <div class="row">
              <div class="col-md-1">
                <img src="<?php echo base_url('uploads/'.$post->thumb); ?>" class="jul-bx">
              </div>
              <div class="col-md-3">
                <h4 class="july-black"><?php echo $post->departure_city;?> <i class="fas fa-arrow-right right-icon-flight"></i> <?php echo $post->arrival_city;?></h4>
                <h4 class="july"><?php echo $post->departure_time;?>(<?php echo $post->departure_date;?>)</h4>
              </div>
              <div class="col-md-2">
                <h4 class="july-black"><?php echo $post->arrival_date;?></h4>
                <h4 class="july"><?php echo $post->arrival_time;?></h4>
              </div>
              <div class="col-md-2">
                <h4 class="july-black"><i class="fas fa-clock right-icon-flight"></i> <?php echo $post->total_hours;?> Hours</h4>
                <h4 class="july"><i class="fas fa-exchange-alt right-icon-flight"></i> 0stops</h4>
              </div>
              <div class="col-md-2">
                <h4 class="jul-font">$price</h4>
                <h4 class="july"><?php echo $uni = $post->price_adults + $post->price_infant + $post->price_child;?></h4>
              </div>
              <div class="col-md-2 flight-serch-page">
                <button type="button" class="btn book-btn"><a href="<?php echo site_url('Car/car_show/'); ?>"><?php echo anchor('Flights/flight_book?id='.$post->id, ' BOOK NOW', array('class' => 'anchor_tag')); ?></a></button>
              </div>
            </div>
          </div>
        </div>
...
<script>
  $(document).ready(function(){
    $("#filter").keyup(function(){
        ...
        $("#fromList .bbb-july-b").each(function(){
