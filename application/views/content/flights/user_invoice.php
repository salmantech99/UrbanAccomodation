                ...
                <div class="invoice-print p-3">
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>$ <?php echo $flight_deposit_price; ?></td>
                                    </tr>
                                    <tr>
                                        <td class="pe-1">Tax & Vat:</td>
                                        <td>$ <?php echo $flight_tax_price; ?></td>
                                    </tr>
                                    <tr>
                                        <td class="pe-1">Total Amount:</td>
                                      <td><strong>$ <?php echo $flight_total_price; ?></strong></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="table-responsive mt-2">
                      <table class="table m-0 table_custom">
                            <thead>
                              <tr>
                                  <th colspan="4"><strong>Departure Information</strong></th>
                                </tr>
                                <tr>
                                    <th class="py-1 ps-4">Airline</th>
                                    <th class="py-1 ps-4">Departure City</th>
                                    <th class="py-1">Departure Date</th>
                                    <th class="py-1">Departure Time</th>
                                </tr>
                            </thead>
                         <tbody>
                           <tr style="height:25px;">
                            <td class="py-1 ps-4">
                              <p class="fw-semibold mb-25"><?php echo $post->departure_airline;?></p>
                            </td>
                             <td class="py-1 ps-4">
                              <p class="fw-semibold mb-25"><?php echo $flight_departure;?></p>
                             </td>
                            <td class="py-1 ps-4">
                              <p class="fw-semibold mb-25"><?php echo $flight_dep_date;?></p>
                             </td>
                             <td class="py-1 ps-4">
                              <p class="fw-semibold mb-25"><?php echo $flight_dep_time;?></p>
                             </td>
                           </tr>
                        </tbody>
                        </table>
                      <br>
                        <table class="table m-0 table_custom">
                            <thead>
                                <tr>
                                  <th colspan="7"><strong>Arrival Information</strong></th>
                                </tr>
                                <tr>
                                    <th class="py-1 ps-4">Arrival City</th>
                                    <th class="py-1">Arrival Date</th>
                                    <th class="py-1">Arrival Time</th>
                                    <th class="py-1">Total Hours</th>
                            ...
                            <tbody>
                                <tr>
                                    <td class="py-1 ps-4">
                                        <p class="fw-semibold mb-25"><?php echo $flight_arrival;?></p>
                                    </td>
                                    <td class="py-1 ps-4">
                                        <p class="fw-semibold mb-25"><?php echo $flight_arr_date;?></p>
                                    </td>
                                    <td class="py-1 ps-4">
                                        <p class="fw-semibold mb-25"><?php echo $flight_arr_time;?></p>
                                    </td>
                                    <td class="py-1 ps-4">
                                        <p class="fw-semibold mb-25"><?php echo $flight_hours;?></p>
                                    </td>
                                    <td class="py-1 ps-4">
                                        <p class="fw-semibold mb-25"><?php echo $flight_price_adult;?></p>
                                    </td>
                                    <td class="py-1 ps-4">
                                        <p class="fw-semibold mb-25"><?php echo $flight_price_child;?></p>
                                    </td>
                                    <td class="py-1 ps-4">
                                        <p class="fw-semibold mb-25"><?php echo $flight_price_infant;?></p>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="d-flex justify-content-between flex-md-row flex-column pb-2">
                        ...
                        <div class="mt-md-0 mt-2">
                            <div class="invoice-date-wrapper mb-50">
                                ...
                                <strong><span>$ <?php echo $flight_deposit_price; ?></span></strong>
                            </div>
                            <div class="invoice-date-wrapper">
                                <span class="invoice-date-title">TAX & VAT:</span>
                                <strong><span>$ <?php echo $flight_tax_price; ?></span></strong>
                            </div>
                            <div class="invoice-date-wrapper">
                                <span class="invoice-date-title">TOTAL AMOUNT:</span>
                                <strong><span>$ <?php echo $flight_total_price; ?></span></strong>
                            </div>
                        </div>
                    </div>
