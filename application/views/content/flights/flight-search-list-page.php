...
<div class="container one-way-margin">
  <div class="row">
    <div class="col-md-4">
      ...
      <div class="bbb">
        <h3>
          <p class="depart-font"><img src="<?php echo base_url(); ?>assets/image/search-hotel/red.png">Fare Type<button aria-expanded="true" class="test">
            <svg viewBox="0 0 10 10">
              <rect class="vert" height="8" width="2" y="1" x="4"/>
              <rect height="2" width="8" y="4" x="1"/>
            </svg> 
        ...
        <div>
          <div class="row">
            ...
            <div class="col-md-8">
              <label class="form-check-label check-font-july" for="inlineCheckbox1">Refundable </label>
            </div>
            <div class="col-md-2">
              <h4 class="fifteen-f">75</h4>
            </div>
          </div>
          <hr>
          <div class="row">
            ...
            <div class="col-md-8">
              <label class="form-check-label check-font-july" for="inlineCheckbox1">Non Refundable </label>
            </div>
            <div class="col-md-2">
              <h4 class="fifteen-f">15</h4>
            </div>
          </div>
        </div> 
      </div>
      ...
      <ul class="jul bbb-july-b-b d-md-block d-none">
        <div class="row">
          ...
          <div class="col-md-8 center slider-slider">
            <div>
              <li class="jul-lili list-slide"><a href="#home" class="july b-july-list">25 JUL<br><span class="july-red">$2562</span></a></li>
            </div>
            <div>
              <li class="jul-lili list-slide"><a href="#home" class="july b-july-list">25 JUL<br><span class="july-red">$2562</span></a></li>
            </div>
        ...
        <div id="computers"> 
          <div class="system bbb-july-b" data-price="<?php echo $uni = $post->price_adults + $post->price_infant + $post->price_child;?>">
            <div class="row">
              ...
              <div class="col-md-3">
                <h4 class="july-black"><?php echo $post->departure_city;?>-<?php echo $post->arrival_city;?></h4>
              ...
              <div class="col-md-2">
                <h4 class="july-black"><?php echo $post->total_hours;?> Hours</h4>
                <h4 class="july">0stops</h4>
              </div>
              <div class="col-md-2">
