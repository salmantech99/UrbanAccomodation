...
(6, 'Enabled', 'BIG BUS TOUR OF DUBAI', '<p>Take a weekend trip on the occasion&nbsp;and create a memorable experience with your loved one. If you are a sun and sea lover, this paradise offers you an array of splendid sandy beaches, where you can spend time relaxing or go on a refreshing ya', 1, 2, 3, 100, 200, 300, 4, 9, 8, 'Discovery Tours', '132.jpg', 'Yes', '10/12/2021', '10/31/2021', 'DUBAI', 'DUBAI', 'DUBAI', 'DUBAI', 'DUBAI', 'DUBAI', 'DUBAI', 'DUBAI', 'DUBAI', 'DUBAI', 'Percentage', '10%', 'Percentage', '5%', '6 Days Around Thailand', 'Malaysia, Myanmar, Cambodia, Laos', '45', '54', '', 'DUBAI TOUR', 'UAE', 'Arrive to the city and transfer to your hotel. Check in and spend the day at leisure.', 'zohaib.xpertcoders@gmail.com', 'www.Info@urbanaccomodation.com', '2147483647', 'house# 47 street #15 new shalimar colony multan road lahore.', 'American Express', 'Prices include return economy-class flights from on Qatar Airways. Prices are quoted on a twin-sharing basis in a standard room with inclusions listed above. Additional options are available ');
